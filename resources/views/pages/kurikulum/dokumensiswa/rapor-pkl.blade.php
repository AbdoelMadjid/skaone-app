...
@section('content')
    ...
    <div class="modal fade" id="RaporPKL" tabindex="-1" aria-labelledby="RaporPKLLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-soft-secondary" id="btn-cetak-pkl">Cetak</button>
...
@section('script-bottom')
    <script>
        ...
        document.getElementById("btn-cetak-pkl").addEventListener("click", function() {
            ...
            var printContents = document.getElementById("cetak-nilai-pkl").innerHTML;
        ...
        $(document).on('click', '.showRaporPKL', function() {
            ...
            $.ajax({
                url: '/kurikulum/dokumentsiswa/raporpkl/' + nis,
                type: 'GET',
                success: function(response) {
                    $('#raporPklBody').html(response);
                },
                error: function() {
                    $('#raporPklBody').html(
