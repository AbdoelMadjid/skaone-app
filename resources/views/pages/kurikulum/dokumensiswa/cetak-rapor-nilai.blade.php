<div id='cetak-hal1' style='@page {size: A4;}'>
    <div class='table-responsive'>
        ...
        <table align='center' width='90%'
            style='margin: 0 auto;width:100%;border-collapse:collapse;font:18px Times New Roman;'>
            <tr>
                <td align='center'>
                ...
                <td align='center'>
                    <table class='cetak-rapor'>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style='text-align:center;padding:4px 8px;font-size:12px;' align='center'>1.</td>
                                <td style='padding:4px 8px;font-size:12px;'>Nama Mata Pelajaran<br>Nama Pengajar</td>
                                <td></td>
                                <td style='padding:4px 8px;font-size:12px;'>Dari jumlah tujuan pembelajaran sebanyak
                                    $JmlTPA, ketercapaian pembelajaran dalam kategori $QNPADeskA karena mendapatkan
                                    angka
                            ...
                            <tr>
                                <td style='text-align:center;padding:4px 8px;font-size:12px;' align='center'>2.</td>
                                <td style='padding:4px 8px;font-size:12px;'>Nama Mata Pelajaran<br>Nama Pengajar</td>
                                <td></td>
                                <td style='padding:4px 8px;font-size:12px;'>Dari jumlah tujuan pembelajaran sebanyak
                                    $JmlTPA, ketercapaian pembelajaran dalam kategori $QNPADeskA karena mendapatkan
                            ...
                            <tr>
                                <td style='text-align:center;padding:4px 8px;font-size:12px;' align='center'>3.</td>
                                <td style='padding:4px 8px;font-size:12px;'>Nama Mata Pelajaran<br>Nama Pengajar</td>
                                <td></td>
                                <td style='padding:4px 8px;font-size:12px;'>Dari jumlah tujuan pembelajaran sebanyak
                                    $JmlTPA, ketercapaian pembelajaran dalam kategori $QNPADeskA karena mendapatkan
                            ...
                            <tr>
                                <td style='text-align:center;padding:4px 8px;font-size:12px;' align='center'>4.</td>
                                <td style='padding:4px 8px;font-size:12px;'>Nama Mata Pelajaran<br>Nama Pengajar</td>
                                <td></td>
                                <td style='padding:4px 8px;font-size:12px;'>Dari jumlah tujuan pembelajaran sebanyak
                                    $JmlTPA, ketercapaian pembelajaran dalam kategori $QNPADeskA karena mendapatkan
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td style='padding:4px 8px;font-size:12px;'>Dari jumlah tujuan pembelajaran sebanyak
                                    $JmlTPB, ketercapaian pembelajaran dalam kategori $QNPADeskB karena mendapatkan
                                    angka
                        ...
                        <td>
                            ...
                            <table class='cetak-rapor'>
                                <tr>
                                    ...
                                    <th width='25%' style='text-align:center;padding:4px 8px;'>Keterangan</strong>
                                    </th>
                                </tr>
                                <tr>
