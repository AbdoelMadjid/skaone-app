<x-form.modal size="lg" title="{{ __('translation.capaian-pembelajaran') }}" action="{{ $action ?? null }}">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    <x-form.input name="kode_cp" id="kode_cp" value="{{ old('code_cp', $data->code_cp) }}"
                        label="Kode CP" readonly />
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <x-form.select name="fase" label="fase" :options="['E' => 'E', 'F' => 'F']" id="fase"
                        value="{{ $data->fase }}" />
                </div>

            </div>
            <div class="mb-4">
                <x-form.input name="element" id="element" value="{{ old('element', $data->element) }}"
                    label="ELemen" />
