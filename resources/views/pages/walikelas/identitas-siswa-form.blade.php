<x-form.modal size="lg" title="{{ __('translation.identitas-siswa') }}" action="{{ $action ?? null }}">
    @if ($data->id)
        @method('put')
    @endif
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                <img id="image-preview"
                    src="{{ $data->foto && file_exists(base_path('images/thumbnail/' . $data->foto)) ? asset('images/thumbnail/' . $data->foto) : asset('build/images/users/user-dummy-img.jpg') }}"
                    width="150" alt="Photo" />
            </div>
        </div>
