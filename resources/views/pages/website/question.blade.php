                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div>
                        @can('create websiteapp/question')
                            <a class="mb-3 btn btn-primary action" href="{{ route('websiteapp.question.create') }}">Tambah
                                Pertanyaan</a>
                        @endcan
                        <a class="mb-3 btn btn-primary" href="{{ route('websiteapp.polling.index') }}">Polling</a>
                    </div>
                </div>
                <div class="card-body">
