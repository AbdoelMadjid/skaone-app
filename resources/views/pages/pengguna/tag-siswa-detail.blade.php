<div class="tab-pane active" id="personalDetails" role="tabpanel">
    <form action="{{ route('profilpengguna.profil-pengguna.update', $user->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <x-form.select name="thnajaran_masuk" :options="$tahunAjaran"
                    value="{{ old('thnajaran_masuk', $pesertaDidik->thnajaran_masuk) }}" label="Masuk Tahun Ajaran"
                    disabled />
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <x-form.select name="status_dalam_kel" :options="[
                    ...
                    value="{{ old('status_dalam_kel', $pesertaDidik->status_dalam_kel) }}"
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <x-form.select name="diterima_kelas" :options="['10' => '10', '11' => '11', '12' => '12']"
                    value="{{ old('diterima_kelas', $pesertaDidik->diterima_kelas) }}" label="Diterima Kelas"
                    disabled />
                <input type="hidden" name="diterima_kelas"
                    value="{{ old('diterima_kelas', $pesertaDidik->diterima_kelas) }}">
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-4">
                <x-form.select name="asalsiswa" :options="['Siswa Baru' => 'Siswa Baru', 'Pindahan' => 'Pindahan']"
                    value="{{ old('asalsiswa', $pesertaDidik->asalsiswa) }}" label="Asal Siswa" disabled />
                <input type="hidden" name="asalsiswa" value="{{ old('asalsiswa', $pesertaDidik->asalsiswa) }}">
            </div>
            <div class="col-md-8">
                <x-form.input name="keterangan_pindah" value="{{ $pesertaDidik->keterangan_pindah }}"
                    label="Keterangan Pindah" disabled />
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <x-form.input type="email" name="kontak_email" value="{{ $pesertaDidik->kontak_email }}"
            ...
            <div class="col-md-6">
                ...
                <x-form.input name="alasan_status" value="{{ $pesertaDidik->alasan_status }}" label="Alasan Status"
                    disabled />
                <input type="hidden" name="alasan_status"
                    value="{{ old('status', $pesertaDidik->alasan_status) }}">
            </div>
        </div>
        <hr>
        <div class="col-lg-12">
