                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div
                                                        ...
                                                        <div class="avatar-xxs">
                                                            @if (!empty($partner->avatar) && file_exists(base_path('images/thumbnail/' . $partner->avatar)))
                                                                <!-- Avatar ditemukan di folder -->
                                                                <img src="{{ asset('images/thumbnail/' . $partner->avatar) }}"
                                            ...
                                            <li id="contact-id-{{ $contact->id }}" data-name="contact">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0 me-2">
                                                        <div class="avatar-xxs">
                                                            @if (!empty($contact->avatar) && file_exists(base_path('images/thumbnail/' . $contact->avatar)))
                                                                <!-- Avatar ditemukan di folder personil -->
                                                                <img src="{{ asset('images/thumbnail/' . $contact->avatar) }}"
