    ...
    <form action="{{ route('profilpengguna.simpanorangtuasiswa') }}" method="POST">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <x-form.input name="nis" value="{{ old('nis', $ortu->nis ?? auth()->user()->nis) }}"
                            label="NIS" readonly />
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <x-form.input name="nm_ayah" value="{{ old('nm_ayah', $ortu->nm_ayah ?? '') }}"
                            label="Nama Ayah" />
                    </div>
                    <div class="col-md-6">
                        <x-form.input name="nm_ibu" value="{{ old('nm_ibu', $ortu->nm_ibu ?? '') }}"
                            label="Nama Ibu" />
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <x-form.input name="ortu_alamat_blok"
                            value="{{ old('ortu_alamat_blok', $ortu->ortu_alamat_blok ?? '') }}" label="Alamat Blok"
                            id="ortu_alamat_blok" />
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <x-form.input name="ortu_alamat_rt"
                            value="{{ old('ortu_alamat_rt', $ortu->ortu_alamat_rt ?? '') }}" label="RT"
                            id="ortu_alamat_rt" />
                    </div>
                    <div class="col-md-2">
                        <x-form.input name="ortu_alamat_rw"
                            value="{{ old('ortu_alamat_rw', $ortu->ortu_alamat_rw ?? '') }}" label="RW"
                            id="ortu_alamat_rw" />
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <x-form.input name="ortu_alamat_desa"
                            value="{{ old('ortu_alamat_desa', $ortu->ortu_alamat_desa ?? '') }}" label="Desa"
                            id="ortu_alamat_desa" />
                    </div>
                    <div class="col-md-4">
                        <x-form.input name="ortu_alamat_kec"
                            value="{{ old('ortu_alamat_kec', $ortu->ortu_alamat_kec ?? '') }}" label="Kecamatan"
                            id="ortu_alamat_kec" />
                    </div>
                    <div class="col-md-4">
                        <x-form.input name="ortu_alamat_kab"
                            value="{{ old('ortu_alamat_kab', $ortu->ortu_alamat_kab ?? '') }}" label="Kabupaten/Kota"
                            id="ortu_alamat_kab" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <x-form.input name="ortu_kontak_telepon"
                            value="{{ old('ortu_kontak_telepon', $ortu->ortu_kontak_telepon ?? '') }}"
                            label="Telepon" />
                    </div>
                    <div class="col-md-6">
                        <x-form.input name="ortu_kontak_email"
                            value="{{ old('ortu_kontak_email', $ortu->ortu_kontak_email ?? '') }}" label="Email" />
                    </div>
                </div>
