                                                                                    ...
                                                                                    @foreach ($months as $monthKey => $monthName)
                                                                                        <li class="nav-item"
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                id="tab-{{ $monthKey }}-{{ $siswa->nis }}"
                                                                                                data-bs-toggle="tab"
                                                                                                data-bs-target="#content-{{ $monthKey }}-{{ $siswa->nis }}"
                                                                                                type="button"
                                                                                                role="tab"
                                                                                    ...
                                                                                    @foreach ($months as $monthKey => $monthName)
                                                                                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                                                                            ...
                                                                                            @php
                                                                                                ...
                                                                                                $absensi_bulanan = DB::table(
                                                                                                    ...
                                                                                                    ->select(
                                                                                                        ...
                                                                                                        DB::raw(
                                                                                                            "SUM(CASE WHEN status = 'ALFA' THEN 1 ELSE 0 END) as jumlah_alfa",
                                                                                                        ),
                                                                                                    )
                                                                                                    ->where(
                                                                                                        'nis',
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div><span
                                                                                                        class="text-success fw-medium fs-12">{{ $absensi_bulanan->jumlah_hadir ?? 0 }}
                                                                                                        Hari</span></div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="d-flex justify-content-between border-bottom border-bottom-dashed py-1">
                                                                                                ...
                                                                                                <div><span
                                                                                                        class="text-success fw-medium fs-12">{{ $absensi_bulanan->jumlah_sakit ?? 0 }}
                                                                                                        Hari</span></div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="d-flex justify-content-between border-bottom border-bottom-dashed py-1">
                                                                                                ...
                                                                                                <div><span
                                                                                                        class="text-success fw-medium fs-12">{{ $absensi_bulanan->jumlah_izin ?? 0 }}
                                                                                                        Hari</span></div>
                                                                                            </div>
                                                                                            <div
                                                                                                class="d-flex justify-content-between border-bottom border-bottom-dashed py-1">
                                                                                                ...
                                                                                                <div><span
                                                                                                        class="text-success fw-medium fs-12">{{ $absensi_bulanan->jumlah_alfa ?? 0 }}
                                                                                                        Hari</span></div>
                                                                                            </div>
                                                                                        </div>
                                                                                    @endforeach
