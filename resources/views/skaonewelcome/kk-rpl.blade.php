        ...
        <div class="row">
            <div class="col-md-3">
                @php
                    ...
                    $photo = DB::table('logo_jurusans')->where('kode_kk', '411')->first();
                ...
                <ul class="nav nav-tabs" id="tahunAjaranTab-411" role="tablist">
                    @foreach ($tahunAjarans as $ta)
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $ta->id == $tahunAjaranAktif->id ? 'active' : '' }}"
                                id="tab-411-{{ $ta->id }}" data-toggle="tab"
                                href="#content-411-{{ $ta->id }}" role="tab"
                                aria-controls="content-411-{{ $ta->id }}"
                ...
                <div class="tab-content mt-3" id="tahunAjaranContent-411">
                    @foreach ($tahunAjarans as $ta)
                        <div class="tab-pane fade {{ $ta->id == $tahunAjaranAktif->id ? 'show active' : '' }}"
                            id="content-411-{{ $ta->id }}" role="tabpanel"
                            aria-labelledby="tab-411-{{ $ta->id }}">

                            <h6>Kompetensi Keahlian 411 ({{ $ta->tahunajaran }})</h6>
                            ...
                            <p class="text-danger fs-6">
                                {{ terbilang($dataPerTahunAjaran[$ta->tahunajaran]['totalSiswaPerKK']['411']) }} orang
                            </p>
                ...
                <div class="container g-mb-60">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 g-mb-40 g-mb-0--lg">
                            ...
                            @if (isset($dataProfil['411']['profil_lulusan']))
                                @foreach ($dataProfil['411']['profil_lulusan'] as $item)
                        ...
                        <div class="col-lg-4 col-md-4 g-mb-40 g-mb-0--lg">
                            ...
                            @if (isset($dataProfil['411']['prospek_kerja']))
                                @foreach ($dataProfil['411']['prospek_kerja'] as $item)
                                    <x-variasi-ceklist-one>{{ $item->deskripsi }}</x-variasi-ceklist-one>
                                @endforeach
                            @endif
                            @php
