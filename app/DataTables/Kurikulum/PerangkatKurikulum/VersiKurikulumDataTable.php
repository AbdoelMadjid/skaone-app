...
class VersiKurikulumDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function query(VersiKurikulum $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('versikurikulum-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nomor')->title('Nomor Aturan'),
            Column::make('tentang')->title('Perihal'),
    ...
    {
        return 'VersiKurikulum_' . date('YmdHis');
    }
}
