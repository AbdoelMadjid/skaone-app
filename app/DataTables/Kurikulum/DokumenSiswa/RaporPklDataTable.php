...
class RaporPklDataTable extends DataTable
{
    use DatatableHelper;
    /**
            ...
            ->addColumn('action', function ($row) {
                ...
                <div class="btn-group dropstart">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                        <li><a href="#" class="dropdown-item showRaporPKL" data-nis="' . $id . '" data-bs-toggle="modal" data-bs-target="#RaporPKL"> Cetak </a></li>
                    </ul>
                </div>';
                return $tombol;
            })
