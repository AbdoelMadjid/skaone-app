...
class DenahRuanganUjianDataTable extends DataTable
{
    use DatatableHelper;
    /**
    ...
    {
        return $this->builder()
            ->setTableId('denahruanganujian-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('kode_ruang')->title('Kode Ruang'),
    ...
    {
        return 'DenahRuanganUjian_' . date('YmdHis');
    }
}
