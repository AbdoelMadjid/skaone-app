...
class PesanPrakerinDataTable extends DataTable
{
    use DatatableHelper;
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addIndexColumn()
            ->rawColumns(['pesan_terkirim', 'pesan_diterima', 'peserta_prakerin', 'action']);
    }
    ...
    {
        return $this->builder()
            ->setTableId('pesanprakerin-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('peserta_prakerin')->title('Peserta Prakerin')->width('20%'),
            Column::make('pesan_terkirim')->title('Pesan Terkirim')->orderable(false)->searchable(false)->width('40%'), // Kolom pesan
            Column::make('pesan_diterima')->title('Pesan Diterima')->orderable(false)->searchable(false)->width('40%'), // Kolom pesan
    ...
    {
        return 'PesanPrakerin_' . date('YmdHis');
    }
}
