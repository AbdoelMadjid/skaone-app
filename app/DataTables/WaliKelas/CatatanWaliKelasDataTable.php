...
class CatatanWaliKelasDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function query(CatatanWaliKelas $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId('catatanwalikelas-table')
    ...
    {
        return 'CatatanWaliKelas_' . date('YmdHis');
    }
}
