...
class BpBkSiswaBermasalahDataTable extends DataTable
{
    use DatatableHelper;
    /**
    ...
    {
        return $this->builder()
            ->setTableId('bpbksiswabermasalah-table')
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nis')->title('Nama Lengkap'),
            Column::make('rombel')->title('Kelas'),
            Column::make('jenis_kasus')->title('Jenis Kasus'),
    ...
    {
        return 'BpBkSiswaBermasalah_' . date('YmdHis');
    }
}
