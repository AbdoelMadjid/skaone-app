...
class JabatanLainDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function query(JabatanLain $model): QueryBuilder
    {
    ...
    {
        return 'JabatanLain_' . date('YmdHis');
    }
}
