...
class LapKaprodiPesertaPrakerinDataTable extends DataTable
{
    use DatatableHelper;
    /**
     ...
     */
    public function DaftarPesertaDidikDataTable(QueryBuilder $query): EloquentDataTable
    {
    ...
    {
        return $this->builder()
            ->setTableId('lapkaprodipesertaprakerin-table')
            ...
            ->buttons([
                ...
                'pageLength' => 60,       // Menampilkan 50 baris per halaman
            ]);
    }
    ...
    {
        return 'LapKaprodiPesertaPrakerin_' . date('YmdHis');
    }
}
