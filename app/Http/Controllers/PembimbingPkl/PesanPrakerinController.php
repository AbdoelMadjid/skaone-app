...
use App\DataTables\PembimbingPkl\PesanPrakerinDataTable;
use App\Models\PembimbingPkl\PesanPrakerin;
use App\Http\Controllers\Controller;
use App\Http\Requests\PembimbingPkl\PesanPrakerinRequest;
...
class PesanPrakerinController extends Controller
{
    ...
    public function index(PesanPrakerinDataTable $pesanPrakerinDataTable)
    {
        ...
        return $pesanPrakerinDataTable->render("pages.pembimbingpkl.pesan-prakerin", compact('pesanMasuk', 'pesanKeluar'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.pembimbingpkl.pesan-prakerin-form', [
