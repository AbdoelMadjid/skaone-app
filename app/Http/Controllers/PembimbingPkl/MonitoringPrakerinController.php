...
use App\DataTables\PembimbingPkl\MonitoringPrakerinDataTable;
use App\Models\PembimbingPkl\MonitoringPrakerin;
use App\Http\Controllers\Controller;
use App\Http\Requests\PembimbingPkl\MonitoringPrakerinRequest;
...
class MonitoringPrakerinController extends Controller
{
    ...
    {
        return $monitoringPrakerinDataTable->render("pages.pembimbingpkl.monitoring-prakerin");
    }
    ...
    public function create()
    {
        ...
        return view('pages.pembimbingpkl.monitoring-prakerin-form', [
