...
use App\DataTables\About\FiturCodingDataTable;
use App\Models\About\FiturCoding;
use App\Http\Controllers\Controller;
use App\Http\Requests\About\FiturCodingRequest;
...
class FiturCodingController extends Controller
{
    ...
    public function index(FiturCodingDataTable $fiturCodingDataTable)
    {
        ...
        return $fiturCodingDataTable->render('pages.about.fitur-coding');
    }
    ...
    {
        return view('pages.about.fitur-coding-form', [
            'data' => new FiturCoding(),
            'action' => route('about.fitur-coding.store')
        ]);
    }
    ...
    public function edit(FiturCoding $fiturCoding)
    {
        return view('pages.about.fitur-coding-form', [
            'data' => $fiturCoding,
            'action' => route('about.fitur-coding.update', $fiturCoding->id)
        ]);
    }
