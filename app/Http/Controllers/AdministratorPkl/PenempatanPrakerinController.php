...
use App\DataTables\AdministratorPkl\PenempatanPrakerinDataTable;
use App\Models\AdministratorPkl\PenempatanPrakerin;
use App\Http\Controllers\Controller;
use App\Http\Requests\AdministratorPkl\PenempatanPrakerinRequest;
...
class PenempatanPrakerinController extends Controller
{
    ...
    {
        return $penempatanPrakerinDataTable->render('pages.administratorpkl.penempatan-prakerin');
    }
    ...
    public function create()
    {
        ...
        return view('pages.administratorpkl.penempatan-prakerin-form', [
            'data' => $data,
