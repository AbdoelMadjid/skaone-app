...
use App\DataTables\KaprodiPkl\ModulAjarDataTable;
use App\Http\Controllers\Controller;
use App\Http\Requests\KaprodiPkl\ModulAjarRequest;
...
class ModulAjarController extends Controller
{
    ...
    {
        return $modulAjarDataTable->render('pages.kaprodipkl.modul-ajar');
    }
    ...
    public function create()
    {
        ...
        return view('pages.kaprodipkl.modul-ajar-form', [
            'data' => $data,
