...
use App\DataTables\PesertaDidikPkl\PesanPesertaPrakerinDataTable;
use App\Http\Controllers\Controller;
use App\Http\Requests\PesertaDidikPkl\PesanSiswaRequest;
...
class PesanPrakerinSiswaController extends Controller
{
    ...
    public function index(PesanPesertaPrakerinDataTable $pesanPesertaPrakerinDataTable)
    {
        ...
        return $pesanPesertaPrakerinDataTable->render("pages.pesertadidikpkl.pesan-siswa", compact('pesanMasuk', 'pesanKeluar'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.pesertadidikpkl.pesan-siswa-form', [
